Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/Neil20170223/ZipArchive'
  s.license      = { :type => 'MIT', :file => 'LICENSE.txt' }
  s.authors      = { 'Sam Soffes' => 'sam@soff.es', 'Joshua Hudson' => nil, 'Antoine Cœur' => nil }
  s.source       = { :git => 'https://github.com/Neil20170223/ZipArchive.git', :tag => "FRSSZipArchive.#{s.version}" }
